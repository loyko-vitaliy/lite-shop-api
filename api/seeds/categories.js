    ...
    knex('categories')
        ...
        .then(() =>
            knex('categories').insert([
                ...
                {name: 'iPad', slug: 'ipad', description: 'Лучшие смартфоны iPad', parent_id: 1},
                {name: 'iPod', slug: 'ipod', description: 'Лучшие смартфоны iPod', parent_id: 1},
                {name: 'Apple Watch', slug: 'apple-watch', description: 'Лучшие смартфоны Apple Watch', parent_id: 1},
            ])
        );
